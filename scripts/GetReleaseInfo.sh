...
jarName="nanaica-$mcversion.jar"
leavesid="Nanaica-$commitid"
...
mv build/libs/Nanaica-paperclip-$gradleVersion-reobf.jar $jarName
echo "name=$nanaicaid" >> $GITHUB_ENV
...
echo "$nanaicaid [![download](https://img.shields.io/github/downloads/NanaicaMC/Nanaica/$tagid/total?color=0)](https://github.com/NanaicaMC/Nanaica/releases/download/$tagid/$jarName)" >> $releaseinfo
echo "=====" >> $releaseinfo
echo "" >> $releaseinfo
...
echo -n "{\"content\":\"Nanaica New Release\",\"embeds\":[{\"title\":\"$nanaicaid\",\"url\":\"https://github.com/NanaicaMC/Nanaica/releases/tag/$tagid\",\"fields\":[{\"name\":\"Changelog\",\"value\":\"" >> $discordmes
